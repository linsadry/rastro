...
{ label: trips.some(t=>t.location?.includes(',')&&!['AC','AL','AP','AM','BA','CE','DF','ES','GO','MA','MT','MS','MG','PA','PB','PR','PE','PI','RJ','RN','RS','RO','RR','SC','SP','SE','TO'].includes(t.location?.split(',').pop()?.trim()))?'Internac.':'Países', value: new Set(trips.filter(t=>t.location?.includes(',')&&!['AC','AL','AP','AM','BA','CE','DF','ES','GO','MA','MT','MS','MG','PA','PB','PR','PE','PI','RJ','RN','RS','RO','RR','SC','SP','SE','TO'].includes(t.location?.split(',').pop()?.trim())).map(t=>t.location?.split(',').pop()?.trim()).filter(Boolean)).size||'—' },
